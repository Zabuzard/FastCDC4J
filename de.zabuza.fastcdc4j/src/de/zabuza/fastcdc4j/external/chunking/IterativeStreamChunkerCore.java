...
public interface IterativeStreamChunkerCore {
	 ...
	 * @param size          Remaining data available in the stream that are subject to be chunked
	 * @param currentOffset Current offset in the given stream, in regards to its original start
	 *
